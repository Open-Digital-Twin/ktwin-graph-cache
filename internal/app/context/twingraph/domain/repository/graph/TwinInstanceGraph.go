...
// 	PrintGraph()
// 	GetTwinInstanceSettings() TwinGraphEnvironmentSettings
...
// func (g *twinInstanceGraph) GetTwinInstanceSettings() TwinGraphEnvironmentSettings {
